  ...
  return (
    <div style={{ width: '80mm', fontFamily: 'monospace', fontSize: '12px', color: '#000', padding: '8px' }}>
      <div style={{ textAlign: 'center', marginBottom: '10px' }}>
        <div style={{ fontSize: '16px', fontWeight: 'bold' }}>GMH Pharmacy</div>
      ...
      <div style={{ textAlign: 'center', fontSize: '10px' }}>
        GMH Pharmacy — {format(new Date(), 'yyyy')}
      </div>
    </div>
  );
}
    ...
    const slipHtml = `
      <div style="width:80mm;font-family:monospace;font-size:12px;color:#000;padding:8px">
        <div style="text-align:center;margin-bottom:10px">
          <div style="font-size:16px;font-weight:bold">GMH Pharmacy</div>
        ...
        <div style="text-align:center;font-size:10px">GMH Pharmacy</div>
      </div>
    `;
    printSlip(slipHtml);
