  ...
  return (
    <div className="min-h-screen bg-gray-50 flex print:bg-white">
      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            <img src={logo} alt="GMH Pharmacy" className="w-8 h-8 rounded-full border-2 border-white shadow" />
            <div>
              <div className="text-white font-bold text-sm leading-tight">GMH Pharmacy</div>
              <div className="text-blue-100 text-xs">POS System</div>
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col min-h-screen overflow-hidden">
        ...
        >
          ...
          <img src={logo} alt="" className="w-7 h-7 rounded-full border border-white/50" />
          <span className="font-semibold text-base">GMH Pharmacy POS</span>
        </header>
